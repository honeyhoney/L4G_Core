...
{
    sLog.outString("Player entered 1");

    if (player->isGameMaster())
    {
        sLog.outString("Player entered GM");
        return;
    }

    sLog.outString("Player entered 2");
    ...
    if (resultPlayerIds)
    {
        sLog.outString("Player entered 3");
        ...
        //sLog.outString("here: %s", playerIds.c_str());

        sLog.outString("Player entered 33");

        while(ss >> playerId)
        {
            sLog.outString("Player entered 333");
            if (playerId == player->GetGUIDLow())
            {
                sLog.outString("Player entered 3333");
                return;
            }
            sLog.outString("Player entered 33333333");
        }
    } else
    {
        sLog.outString("Player entered 4");
    }

    sLog.outString("Player entered 5");
